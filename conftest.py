...
custom_settings = dict(
    ...
    LOCAL_SCRAPYD_LOGS_DIR='D:\Workspace\Digitalia\Aliaxis\Demos\scrpydweb',  # For LogParser, defaults to the 'logs' directory that resides in current user directory
